...
vector<tuple<string, int, string, int, string>> ViewJobApplications::showUsersJobApplication() {
    ...
    vector<tuple<string, int, string, int, string>> orderedJobApplicationList;
