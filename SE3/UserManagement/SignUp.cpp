...
int SignUp::createGeneralUser(string name, int personalNum, string id, string password){
...
int SignUp::createCompanyUser(string name, int companyNum, string id, string password) {
    extern UserList userDB; // main 함수에 선언 된 userDB 사용
