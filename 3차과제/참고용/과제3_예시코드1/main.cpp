        ...
        switch(menu_level_1)
        {
            case 1:
            {
                switch(menu_level_2)
                {
                    ...
                    {
                        Join controlClass_Join = Join(in_fp, out_fp, &userDB );
                        break;
                    }
                    case 2:
                    {
            ...
            case 5:
            {
                ...
                {
                    // 5.1. 판매 상품 통계
                    ProductSellStatisticsInquiry* productSellStaticsInquiry = new ProductSellStatisticsInquiry();
                    productSellStaticsInquiry->startInterface(out_fp, &sellHistory, productList);
                    break;
                }
                }
            }
